 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Wed Apr 13 09:30:26 2016
*/
...
{
    const real32_T   *duty  = (const real32_T*) ssGetInputPortSignal(S,0);
    const real_T   *xD = ssGetDiscStates(S);

    PWM_init_Outputs_wrapper(duty, xD);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    PWM_init_Update_wrapper(duty,  xD);
}
