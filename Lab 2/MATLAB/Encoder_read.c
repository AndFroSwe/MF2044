 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Wed Apr 13 10:51:05 2016
*/
...
/* Output Port  0 */
#define OUT_PORT_0_NAME      rpm_out
...
{
    real32_T        *rpm_out  = (real32_T *)ssGetOutputPortRealSignal(S,0);
    const real_T   *xD = ssGetDiscStates(S);

    Encoder_read_Outputs_wrapper(rpm_out, xD);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    Encoder_read_Update_wrapper(rpm_out,  xD);
}
